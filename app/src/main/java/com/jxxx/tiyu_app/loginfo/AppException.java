...
public class AppException implements UncaughtExceptionHandler {
     ...
     * @param context
     */
    public void init(Context context,boolean a) {
        Log.w("AppException","AppException:"+a);
        mContext = context;
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/PdaChina/";
